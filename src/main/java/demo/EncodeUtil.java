 ...
 *
 * 作者：飘逸峰
 * 链接：https://www.jianshu.com/p/c716fa3c4678
 * 來源：简书
...
public class EncodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String contentStr = "helloworld 你好";
        ...
        //ecb128 String
        String encryptString = EncodeUtil.aesEncryptToECB(contentStr,key128);
        String decryptString = EncodeUtil.aesDecryptToECB(encryptString,key128);
        System.out.println(decryptString);

        //ecb256 String
        encryptString = EncodeUtil.aesEncryptToECB(contentStr,key256);
        ...
        //cbc128 String
        encryptString = EncodeUtil.aesEncryptToCBC(contentStr,key128,iv);
        decryptString = EncodeUtil.aesDecryptToCBC(encryptString,key128,iv);
        System.out.println(decryptString);

        //cbc256 String
        encryptString = EncodeUtil.aesEncryptToCBC(contentStr,key256,iv);
